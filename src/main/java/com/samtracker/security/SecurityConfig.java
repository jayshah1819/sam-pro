...
public class SecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        provider.setUserDetailsService(credentialDetailsService);
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Temporary maintenance endpoint guarded by its own shared-secret header check.
                ...
                .addFilterAfter(new TenantFilter(jwtService), JwtAuthenticationFilter.class);
        return http.build();
    }
}
